...
class _VerifyCodeWidgetState extends State<VerifyCodeWidget> {
  ...
  void initState() {
    ...
    _model.codiceOTPController ??= TextEditingController();
    _model.codiceOTPFocusNode ??= FocusNode();
        ...
        child: Column(
          ...
          children: [
            ...
            Column(
              ...
              children: [
                Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(16.0, 0.0, 0.0, 15.0),
                  child: RichText(
                    textScaleFactor: MediaQuery.of(context).textScaleFactor,
                    text: TextSpan(
                      children: [
                        TextSpan(
                          text: 'Ti abbiamo inviato un codice al numero:',
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: TextFormField(
                      controller: _model.codiceOTPController,
                      focusNode: _model.codiceOTPFocusNode,
                      autofillHints: const [AutofillHints.email],
                      obscureText: false,
                      decoration: InputDecoration(
                        labelText: 'Codice OTP',
                        labelStyle: FlutterFlowTheme.of(context).labelMedium,
                        hintText: 'Inserisci qui il codice',
                      ...
                      validator: _model.codiceOTPControllerValidator
                          .asValidator(context),
                    ),
                  ),
                ),
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            ...
                            final smsCodeVal = _model.codiceOTPController.text;
