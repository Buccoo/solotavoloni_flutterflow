              ...
              for (var country in maps)
                _getClippedImage(
                  ...
                  onCountrySelected: (selectedCountry) {
                    ...
                    if (selectedCountry.id == "TUO OPEN") {
                      widget.tuoopen!();
                    }
                    // else if (selectedCountry.id == "TUO BASSIO") {
                    //   widget.tuobassio!();
                    // } else if (selectedCountry.id == "DONGIO") {
                    //   widget.dongio!();
                    // } else if (selectedCountry.id == "MARTINI LOUNGE") {
